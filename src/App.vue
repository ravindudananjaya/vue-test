<template>
  <div id="app">
     <svg class="logo" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 496.474 496.474" style="enable-background:new 0 0 496.474 496.474;" xml:space="preserve">
        <path style="fill:#E95353;" d="M489.544,269.628c-0.729-14.739-6.206-28.858-15.205-40.572  c-20.294-26.422-24.25-47.399-24.25-47.399c-15.934-41.751-30.099-69.57-40.51-87.226c-10.954-18.541-29.898-31.03-51.262-33.776  c-42.961-5.554-177.23-5.554-220.191,0c-21.349,2.762-40.293,15.251-51.247,33.776c-10.411,17.656-24.56,45.475-40.51,87.226  c0,0-3.956,20.977-24.25,47.399c-8.983,11.714-14.476,25.833-15.189,40.572c-1.536,31.977,7.727,39.005,16.012,111.368  c0.652,5.694,5.461,9.976,11.202,9.976h428.203c5.741,0,10.55-4.298,11.202-9.976c2.327-20.294,9.232-61.456,9.232-61.456  C488.83,299.076,490.149,282.397,489.544,269.628z"/>
        <path style="fill:#168DE2;" d="M441.074,179.982c-12.567-31.449-25.383-58.911-38.136-80.803  c-9.666-16.555-26.717-28.113-45.583-30.642c-43.055-5.71-175.476-5.663-218.221,0c-18.866,2.529-35.918,14.088-45.584,30.642  c-12.924,22.171-25.91,50.005-38.291,80.803C183.662,190.082,312.655,190.082,441.074,179.982z"/>
        <path style="fill:#FFFFFF;" d="M422.844,216.349c-4.903,1.536-9.464,3.693-13.281,5.834c-6.951,3.879-14.088,7.494-21.535,10.318  c-12.35,4.686-14.445,11.683-14.445,11.683c-0.372,0.481-0.729,0.962-1.071,1.458c-9.371,13.917,2.932,32.442,19.549,30.084  c24.033-3.398,43.83-10.364,53.884-14.398c5.756-2.312,10.255-7.121,11.729-13.157c0.14-0.574,0.264-1.148,0.372-1.707  C461.74,226.543,442.191,210.314,422.844,216.349z"/>
        ...
        <path style="fill:#454545;" d="M473.547,380.965c-0.652,5.71-5.477,10.007-11.217,10.007h-51.433v29.851  c0,10.566,8.564,19.146,19.146,19.146h32.303c10.566,0,19.146-8.564,19.146-19.146v-93.448  C479.366,340.315,475.239,366.179,473.547,380.965z"/>
        <path style="fill:#ED6262;" d="M496.107,159.083c-1.552-6.951-8.083-11.667-15.205-11.667h-12.909  c-8.27,0-14.972,6.703-14.972,14.972v9.2h-6.842l3.925,9.325h15.05c7.789,0,15.5-1.676,22.575-4.918  C494.105,173.078,497.674,166.096,496.107,159.083z"/>
        ...
        <path style="fill:#777777;" d="M426.226,374.511c-27.834-48.159-59.842-46.654-59.842-46.654H130.073  c0,0-31.992-1.505-59.842,46.654H22.119l0.59,6.206c0.543,5.834,5.415,10.256,11.248,10.256h428.56  c5.834,0,10.705-4.422,11.249-10.255l0.59-6.206L426.226,374.511L426.226,374.511z"/>
        <path style="fill:#454545;" d="M34.143,390.988c-5.741,0-10.566-4.313-11.217-10.007c-1.691-14.786-5.834-40.665-7.944-53.589  v93.448c0,10.566,8.564,19.146,19.146,19.146H66.43c10.566,0,19.146-8.564,19.146-19.146v-29.851H34.143z"/>
        <path style="fill:#ED6262;" d="M43.436,171.588v-9.2c0-8.27-6.703-14.972-14.957-14.972H15.571c-7.121,0-13.653,4.717-15.205,11.667  c-1.567,6.997,2.017,13.995,8.378,16.896c7.09,3.243,14.786,4.918,22.575,4.918h15.05l3.925-9.325h-6.858V171.588z"/>
    ...
    <div class="navigation">
      ...
      <label class="btn btn-outline-primary" for="btnradio2">Work done</label>
      <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
      <label class="btn btn-outline-primary" for="btnradio3">Details</label>
      <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
      <label class="btn btn-outline-primary" for="btnradio4">Contact</label>
    </div>
      <!-- <navigation /> -->
    </div>
